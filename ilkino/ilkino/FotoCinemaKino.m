...
@implementation FotoCinemaKino
@synthesize theUrls;
@synthesize theData;
@synthesize theScrollView;

BOOL fotoCinemaLoaded;
...
- (void)loadURL {
    fotoCinemaLoaded = TRUE;
    // Load and parse an xml string
    NSString *feedURLString = [[[NSBundle mainBundle] infoDictionary] objectForKey:@"USRUrlOfFotoCinemaKino"];    
